...
static const char qt_meta_stringdata_DragWidget[] = {
    "DragWidget\0\0AddToBet(float)\0"
    "RemoveFromBet(float)\0PlayChipSound()\0"
    "ClearChips()\0"
};
...
void DragWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->AddToBet((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->RemoveFromBet((*reinterpret_cast< float(*)>(_a[1]))); break;
